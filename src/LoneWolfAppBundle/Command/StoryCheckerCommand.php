...
class StoryCheckerCommand extends ContainerAwareCommand
{

    protected function configure()
    {
        $this
            ->setName('lonewolf:story:check')
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $storyLoader = $this->getContainer()->get('lone_wolf_app.story_checker');
        $storyLoader->compareCampaignList($subCampaignList);
    }
}